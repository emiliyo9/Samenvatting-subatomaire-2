...
Hier wordt er enkel gebruik gemaakt van de elektromagnetische wisselwerking. Zie terug Thomson voor de regels. Het is belangrijk om te begrijpen dat de $\frac{1}{q^2}$ in de propagator van QED zal aangeven hoe gemakkelijk het zal zijn om een foton van de ene naar de andere kant een impuls $q$ zal meenemen.
...
Uit experimenten bleek dat het heilig boontje, de partiteit, niet behouden wordt bij de zwakke wisselwerking. Later is gezien dat de pariteit volledig zal schenden. De nieuwe theorie die hier is ontwikkeld zegt dat in de operator van de zwakke wisselwerking zowel een vector gedeelte als pseudo-vector gedeelte zit, $P_L= \frac{1}{2} (1-\gamma^5)$ die de links handige toestanden uit projecteert. Dit geeft de (V-A)-interactie
\begin{equation}
    \begin{aligned}
        \label{eq:v_a_int}
